...
from dependencies import get_admin, get_db, get_current_employee
from schemas.account import (
    AccountCreate, AccountRead, UserLogin, PasswordChange
)
from schemas.employee import (
    EmployeeCreate, EmployeeRead, EmployeeLogin
)
...
def get_balance(
    ...
    # authenticate_account will raise 401 if creds are invalid
